...
<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/pt-act/strix/issues">
    Report bugs and request features.
  </Card>
  <Card title="Pull Requests" icon="code-pull-request" href="https://github.com/pt-act/strix/pulls">
